...
ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('no founds')));
      }
      else {
...
showModalBottomSheet(context: context, builder: (context) {
  return PaymentWalletWidget(title: 'Upgrade your plan', des: 'new plan to benefits', package: packages, onClickedPackage: (value) async {
    await PurchaseApis.purchasePackage(value);Navigator.pop(context);
  },);
        ...
        children: [
          Column(
            ...
            children: [
              ...
              entitle == Entitlement.free? Text('You are on free plan'): Text('you are on paid plan'),
